...
desc 'Generate documentation for the service_contracts extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ServiceContractsExtension'
...
desc 'Test the service_contracts extension.'
...
namespace :test do
  desc 'Functional test the service_contracts extension.'
  ...
  desc 'Unit test the service_contracts extension.'
